            ...
            <div className="w-full max-w-md glass-panel p-8 z-10 text-center relative overflow-hidden border border-pink-500/10">
                ...
                <form onSubmit={handlePatientSubmit} className="space-y-4 text-left">
                    ...
                    <button
                        ...
                        className="w-full flex justify-center items-center gap-2 bg-gradient-to-r from-pink-600 to-purple-600 hover:from-pink-500 hover:to-purple-500 text-white font-bold py-3 rounded-lg mt-6 transition-all shadow-[0_0_20px_rgba(236,72,153,0.3)] hover:shadow-[0_0_30px_rgba(236,72,153,0.5)] disabled:opacity-50"
                    >
                ...
                <div className="relative pt-6 border-t border-slate-800">
                    ...
                    >
                        {adminLoading ? <Loader2 className="w-4 h-4 animate-spin text-purple-400" /> : <UserCog className="w-4 h-4 text-purple-400" />}
